...
Specifically, 9 radial descriptors ($r_\text{cutoff}=6\,\text{\AA}$) and 
42 angular descriptors ($r_\text{cutoff}=4\,\text{\AA}$) are employed, 
...
\begin{equation}
\label{eq:rescaling}
\mathcal{F} = \frac{1}{\left|e_i - e_{\beta\,\text{phase}}\right|^{\alpha} + 1},
\end{equation}
where $e_i$ is the average potential energy per atom of the $i$th configuration, $e_{\beta\,\text{phase}}$ 
is that of the $\beta$ phase, and $\alpha$ is a small constant controlling the strength of the rescaling.
